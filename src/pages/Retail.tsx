      ...
      <section className="py-8 pb-0 relative overflow-hidden bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${bgrailway})` }}>
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-0 relative z-10">
          <div className="pt-10">
            ...
            {/* Dashboard Container */}            <div className="relative flex justify-center items-center  rounded-2xl ">
              ...
              <div className="relative max-w-7xl  w-full flex justify-center items-center ">
                ...
                <motion.img
                  ...
                  alt="dashboard"
                  loading="lazy"
                  className="rounded-xl relative z-20 w-[90%] sm:w-[80%] -mb-8 md:-mb-12 xl:-mb-16  xl:w-auto h-auto xl:h-[560px] object-cover shadow-2xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 top-[-10px] xl:top-[-20px] w-[100px] sm:w-[140px] xl:-left-0 xl:w-72 rounded-xl shadow-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 bottom-[-10px] w-[80px] sm:w-[110px] xl:-left-[-30px]  xl:bottom-12  xl:w-[260px] rounded-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 top-[-10px] xl:top-[-20px] w-[110px] sm:w-[150px] xl:-right-10 xl:w-80 rounded-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 bottom-[-10px] w-[110px] sm:w-[150px] xl:-right-[60px] xl:bottom-2 xl:w-72 rounded-xl"
                />
