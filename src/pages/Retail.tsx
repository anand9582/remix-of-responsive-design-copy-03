...
import retailbannerfirst from "@/assets/retailbannerfirst.webp";
import retailbannersecond from "@/assets/retailbannersecond.webp";
import retailbannerthird from "@/assets/retailbannerthird.webp";
import retailbannerfourth from "@/assets/retailbannerfourth.webp";
import retailmobilefirst from "@/assets/retailmobilefirst.jpg";
import retailmobilesecond from "@/assets/retailmobilesecond.jpg";
import retailmobilethird from "@/assets/retailmobilethird.jpg";
import retailmobilefourth from "@/assets/retailmobilefourth.jpg";
...
import aboutCtaBg from "@/assets/retail_cta.png";
// Swiper
...
const Retail = () => {
  ...
  const retailSchema = {
    ...
    "@type": "Product",
    "name": "CamPulse Retail Security Solution",
    "description": "Smart AI video surveillance for retail loss prevention, customer foot traffic analytics and multi-outlet central management.",
  ...
  return (
    <div className="min-h-screen bg-white pt-16 lg:pt-0">
      <SEO
        title="Smart Retail VMS & Loss Prevention Solutions | CamPulse"
        description="Protect retail stores from shrinkage, analyze customer foot traffic, and manage multiple outlets centrally with CamPulse AI-powered video surveillance."
        keywords="retail security, loss prevention, store foot traffic analysis, multi-store surveillance, smart retail VMS"
        path="/retail"
        schema={retailSchema}
      />
      {/* Hero Section */}
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  "
                  >
                    <div className="text-[#2563EB] transition-colors duration-500 mb-3">
                      <feature.icon />
                    </div>
                  </div>
            ...
            <div className="relative flex justify-center items-center  rounded-2xl ">
              ...
              <div className="relative max-w-7xl  w-full flex justify-center items-center ">
                ...
                <motion.img
                  ...
                  alt="dashboard"
                  loading="lazy"
                  className="relative z-20 w-[90%] sm:w-[80%] -mb-8 md:-mb-12 xl:-mb-16  xl:w-auto h-auto xl:h-[560px] object-cover shadow-2xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 top-[-10px] xl:top-[-20px] w-[100px] sm:w-[140px] xl:-left-0 xl:w-72"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 bottom-[0px] w-[80px] sm:w-[110px] xl:-left-[-30px]  xl:bottom-12  xl:w-[260px]"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 top-[-10px] xl:top-[-20px] w-[110px] sm:w-[150px] xl:-right-10 xl:w-80"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 bottom-[-5px] w-[110px] sm:w-[150px] xl:-right-[60px] xl:bottom-2 xl:w-72"
                />
      ...
      <AboutUs variant="industry">
        ...
        >
          <div className="col-span-12 ">
            ...
            <div className="relative rounded-xl lg:rounded-2xl overflow-hidden h-[240px]  lg:h-[330px] flex items-center justify-center text-center shadow-xl">
