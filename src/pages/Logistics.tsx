...
import LogisticsThird from "@/assets/logistics-third.webp";
import aboutCtaBg from "@/assets/logistics_bg.jpg";
import Logisticsfourth from "@/assets/logistics-fourth.webp";
import logisticsdashboard from "@/assets/logistics-dashboard.png";
import Logisticssecond from "@/assets/logistics-second.webp";
...
import logisticsfirst from "@/assets/logistics-first.webp";

import logisiticsfirst from "@/assets/logisiticsfirst.jpg";
import logisiticssecond from "@/assets/logisiticssecond.jpg";
import logisiticsthird from "@/assets/logisiticsthird.jpg";
import logisiticsfourth from "@/assets/logisiticsfourth.jpg";
...
const heroSlides = [
  {
    ...
    title: (
      <>
        CamPulse for <br /> Logistics &   Warehousing
      </>
    ),
...
const Logistics = () => {
  ...
  const logisticsSchema = {
    ...
    "@type": "Product",
    "name": "CamPulse Logistics Security Solution",
    "description": "End-to-end supply chain AI video surveillance for cargo docks, distributed warehouses and inventory theft prevention.",
  ...
  return (
    <div className="min-h-screen bg-white pt-16 lg:pt-0">
      <SEO
        title="Logistics & Warehouse VMS Security Solutions | CamPulse"
        description="Optimize cargo dock loading, prevent inventory theft, and monitor distributed warehouses with CamPulse. AI-powered end-to-end supply chain video solutions."
        keywords="warehouse security, logistics VMS, inventory loss prevention, cargo dock monitoring, supply chain surveillance"
        path="/logistics"
            ...
            <div className="relative flex justify-center items-center  rounded-2xl">
              ...
              <div className="relative max-w-7xl  w-full flex justify-center items-center">
                ...
                <motion.img
                  ...
                  alt="dashboard"
                  loading="lazy"
                  className="rounded-xl relative z-20 w-[90%] sm:w-[80%] xl:w-auto h-auto xl:h-[640px] -mb-16 md:-mb-28 xl:-mb-40  object-cover"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 top-[-20px] lg:top-1 w-[100px] sm:w-[140px] xl:-left-0 xl:top-1 xl:w-[360px] rounded-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 left-2 bottom-[-1px] lg:bottom-[-10px] w-[80px] sm:w-[110px] xl:-left-[-5px] xl:bottom-5 xl:w-[360px] rounded-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 top-[-20px] lg:top-1 w-[110px] sm:w-[150px] xl:-right-5 xl:top-1 xl:w-80 rounded-xl"
                />
                ...
                <motion.img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute z-30 right-2 bottom-[-0px] lg:bottom-[-10px] w-[80px] sm:w-[150px] xl:-right-4 xl:bottom-0 xl:w-72 rounded-xl"
                />
