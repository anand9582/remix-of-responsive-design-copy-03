...
import OilCtaBg from "@/assets/oil-cta.jpg";
import oilgasMain from "@/assets/oilgas-main.png";
import oilgaslt from "@/assets/oilgaslt.png";
import oilgasfirst from "@/assets/oilgasfirst.webp";
import oilgassecond from "@/assets/oilgassecond.webp";
import oilgasthird from "@/assets/oilgasthird.webp";
import oilgasfourth from "@/assets/oilgasfourth.webp";
import oilgaslb from "@/assets/oilgaslb.png";
import oilgasmobilefirst from "@/assets/oilgasmobilefirst.jpg";
import oilgasmobilesecond from "@/assets/oilgasmobilesecond.jpg";
import oilgasmobilethird from "@/assets/oilgasmobilethird.jpg";
import oilgasmobilefourth from "@/assets/oilgasmobilefourth.jpg";
...
const OilGas = () => {
  ...
  const oilGasSchema = {
    ...
    "@type": "Product",
    "name": "CamPulse Oil & Gas Security Solution",
    "description": "AI thermal imaging, leak detection and perimeter surveillance VMS for remote refineries and pipeline networks.",
  ...
  return (
    <div className="min-h-screen bg-white pt-16 lg:pt-0">
      <SEO
        title="Oil & Gas Industrial VMS Security Solutions | CamPulse"
        description="Protect remote refineries, storage depots, and pipeline networks with CamPulse. AI thermal imaging, leak detection, and advanced boundary perimeter security."
        keywords="oil and gas security, refinery monitoring, pipeline surveillance, thermal video security, leak detection VMS"
        path="/oil-gas"
        schema={oilGasSchema}
      />
      {/* Hero Section */}
      ...
      <section className="md:py-20 py-12 bg-[#F8FAFC] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal direction="up" delay={150}>
            <h2 className="text-center font-aleo font-semibold text-[26px] md:text-[36px] leading-[1.4] tracking-[-0.03em] text-[#111827] lg:mb-10 mb-6">
              How{" "}
              ...
              <div className="relative max-w-7xl  w-full flex justify-center items-center">
                <div className="relative w-[90%] sm:w-[80%] xl:w-auto -mb-16 md:-mb-28 xl:-mb-40">
                  ...
                  <motion.img
                    ...
                    alt=""
                    loading="lazy"
                    className="absolute z-30 left-[-8px] top-1 w-[110px] sm:w-[140px] xl:-left-24 xl:top-1 xl:w-72 rounded-xl"
                  />
                  ...
                  <motion.img
                    ...
                    alt=""
                    loading="lazy"
                    className="absolute z-30 left-[-8px] bottom-[70px] w-[90px] sm:w-[110px] xl:-left-40 xl:bottom-[160px] xl:w-[350px] rounded-xl"
                  />
                  ...
                  <motion.img
                    ...
                    alt=""
                    loading="lazy"
                    className="absolute z-30 right-[-8px] top-1 w-[70px] sm:w-[150px] xl:-right-[8.5rem] xl:top-1 xl:w-80 rounded-xl"
                  />
                </div>
              </div>
            </div>
