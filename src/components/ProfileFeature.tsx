  ...
  return (
    <div ref={ref} className={`grid md:grid-cols-12 gap-6 ${className}`}>
      ...
      <ScrollReveal
        direction="left"
        delay={100}
        className={`md:col-span-5 ${variant === "image"
          ? "relative rounded-md overflow-hidden h-[380px] border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.06)]"
          : "rounded-xl bg-[#1D1D1F] p-6 flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.15)] min-h-[380px]"
          }`}
      >
      ...
      <ScrollReveal
        direction="right"
        delay={200}
        className="md:col-span-7 rounded-md bg-gradient-to-br from-[#1b44c8] to-[#0a2365] p-10 sm:p-12 flex flex-col justify-center relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)]"
      >
        {/* Watermark */}
        ...
        <h3 className="text-white text-[28px] md:text-[30px] uppercase mb-6 leading-[1.3] max-w-2xl">
          {title}
        </h3>
