...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-24 lg:pt-36 text-center">
        {/* Heading */}
        <motion.h1
        ...
        >
          ...
          >
            <button className="group relative flex items-center rounded-full h-11 text-[15px] lg:text-sm font-semibold shadow-lg overflow-hidden w-[164px] bg-white hover:bg-[linear-gradient(96.6deg,#2563EB_5.01%,#153885_92.14%)] transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]">
              {/* Gradient Overlay */}
