      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-6 lg:hidden">
          ...
          <div className="flex flex-col gap-6 flex-1">
            <div className="rounded-md overflow-hidden shadow-custom aspect-[2/3]">
              <video src={surveillance1} autoPlay loop muted playsInline className="w-full h-full object-cover" />
            </div>
            <div className="rounded-md bg-white p-6 shadow-custom border border-neutral-100">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-video">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[9/16]">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[5/4]">
          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[4/3]">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[3/2]">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[4/5]">
        ...
        <div className="hidden lg:grid grid-cols-4 gap-4 xl:gap-6">
          ...
          <div className="flex flex-col gap-4 xl:gap-6 h-full gap-4 xl:gap-6 flex-1">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[5/7]">
              <video src={surveillance8} autoPlay loop muted playsInline className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 xl:gap-6 flex-1">
            ...
            <div className="rounded-md overflow-hidden shadow-custom aspect-[2/2">
          ...
          <div className="flex flex-col gap-4 xl:gap-6 flex-1">
            ...
            <div className="rounded-md overflow-hidden shadow-custom h-[270px]">
              <video src={surveillance5} autoPlay loop muted playsInline className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 xl:gap-6 flex-1">
            ...
            <div className="rounded-md overflow-hidden shadow-custom h-[460px]">
              <video src={surveillance6} autoPlay loop muted playsInline className="w-full h-full object-cover" />
            </div>
            <div className="rounded-md bg-white p-6 shadow-custom border border-neutral-100">
              <div className="flex items-start justify-between mb-1">
