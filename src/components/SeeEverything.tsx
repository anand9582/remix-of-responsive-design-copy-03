...
const LazyVideo = ({ src, className }: { src: string; className?: string }) => {
  ...
  return (
    <div ref={ref} className="w-full h-full bg-neutral-900">
      {isInView && (
  ...
  return (
    <section className="bg-[linear-gradient(116.72deg,#F5F5F5_0%,#F5F5F5_100%)] py-16 sm:py-24">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-center font-roboto font-medium text-neutral-600 text-[30px] sm:text-[34px] mb-12 lg:mb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:hidden">
          ...
          <div className="flex flex-col gap-4 sm:gap-6 flex-1">
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">95%+ Detection Accuracy:</h3>
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">1000+ Cameras, One View:</h3>
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">24/7 Monitoring:</h3>
          ...
          <div className="flex flex-col gap-4 sm:gap-6 flex-1">
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">{"<2s Alert Time:"}</h3>
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">99.9% Uptime:</h3>
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">Enterprise Scale:</h3>
            ...
            <div className="rounded-[16px] bg-white p-6">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">Continuous Learning:</h3>
        ...
        <div className="hidden lg:grid grid-cols-4 gap-5 auto-rows-[760px]">
          ...
          <div className="flex flex-col gap-4 xl:gap-5">
            <div className="rounded-[16px] overflow-hidden aspect-[4/3] bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance1} className="w-full h-full object-cover" />
            </div>
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">95%+ Detection Accuracy:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Reduce false alarms and maximize your overall facility security.</p>
            </div>
            <div className="rounded-[16px] overflow-hidden aspect-[3/4] bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance8} className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          {/* Column 2 */}
          <div className="flex flex-col gap-4 xl:gap-5">
            <div className="rounded-[16px] overflow-hidden aspect-video bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance2} className="w-full h-full object-cover" />
            </div>
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">1000+ Cameras, One View:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Consolidate hundreds of feeds into one unified, intuitive dashboard.</p>
            </div>
            <div className="rounded-[16px] overflow-hidden aspect-video bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance9} className="w-full h-full object-cover" />
            </div>
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">99.9% Uptime:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Mission-critical reliability designed for your continuous, daily operations.</p>
            </div>
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">Enterprise Scale:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Seamlessly integrates with any existing NVR/VMS security infrastructure.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 xl:gap-5">
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">24/7 Monitoring:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Eliminate all blind spots across your locations, around the clock.</p>
            </div>
            <div className="rounded-[16px] overflow-hidden aspect-[4/3] bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance3} className="w-full h-full object-cover" />
            </div>
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">Continuous Learning:</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Advanced AI modules that evolve and improve every day.</p>
            </div>
            <div className="rounded-[16px] overflow-hidden aspect-[4/3] bg-neutral-900 shadow-sm border border-neutral-100">
              <LazyVideo src={surveillance7} className="w-full h-full object-cover" />
            </div>
          ...
          <div className="flex flex-col gap-4 xl:gap-5">
            ...
            <div className="rounded-[16px] bg-white p-6 shadow-sm border border-neutral-100">
              <h3 className="font-roboto font-bold text-[16px] text-neutral-900 mb-2">{"<2s Alert Time:"}</h3>
              <p className="font-roboto text-[14.5px] leading-[1.6] text-neutral-500 pr-2">Instant, real-time alerts delivered straight to your mobile device.</p>
            </div>
          </div>
        </div>
      </div>
